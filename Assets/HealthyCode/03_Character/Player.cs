...
public class Player : MonoBehaviour
{
    ...
    private Bounds currentRoomBounds;  //전투 중 스캔 범위 = 방 크기
    ...
    private void FixedUpdate()
    {
        ...
        rb.velocity = (moveInput.sqrMagnitude > 0.000001f)
            ? moveInput.normalized * stats.moveSpeed
            : Vector2.zero;
    }
    ...
    private void TryFire()
    {
        ...
        float stepDeg = (n > 1) ? (rangedData.spreadDeg / (n - 1)) : 0f;
        float startDeg = -rangedData.spreadDeg * 0.5f;
